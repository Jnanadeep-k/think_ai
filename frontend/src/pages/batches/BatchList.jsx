...
export default function BatchList() {
  ...
  // 1. Filter Batches by search (name, instructor, course title) and status
  ...
  return (
    // Main Wrapper: Fixed height, Flex column, Hidden overflow matching AdminUsersPage
          ...
          <table className="w-full text-sm">
            <thead className="sticky top-0 bg-[#151025] z-10 shadow-md">
              <tr className="border-b border-slate-700 text-left text-xs text-slate-400">
                ...
                <th className="p-4 font-medium uppercase tracking-wider">Instructor</th>
                <th className="p-4 font-medium uppercase tracking-wider">Capacity</th>
                <th className="p-4 font-medium uppercase tracking-wider">Start Date</th>
                <th className="p-4 font-medium uppercase tracking-wider">End Date</th>
              ...
              {currentBatches.map((batch) => {
                ...
                return (
                  <tr key={batch.id} className="border-b border-slate-800/60 hover:bg-white/[0.02] transition-colors">
                    ...
                    <td className="p-4 text-gray-300">{batch.instructorName || "-"}</td>
                    <td className="p-4">
